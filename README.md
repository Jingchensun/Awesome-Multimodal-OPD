...
> 🔄 **Stats last updated: 2026-06-18 05:26 UTC** · ⭐ stars via GitHub API · Citations via Semantic Scholar (Google Scholar has no public API and is blocked in CI; see [`scripts/update_stats.py`](scripts/update_stats.py)).
