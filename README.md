...
> A curated list of **multimodal On-Policy Distillation (OPD / OPSD)** papers — focused on **VQA, Video QA, visual reasoning, speech, generation, and embodied / VLA** settings.
...
Compiled by filtering the multimodal entries of three awesome lists and **augmented with web search**:
...
**What is OPD?** `C1`: the student samples its own trajectories `y ~ π_student(·|x)` during training; `C2`: a teacher provides per-token / sequence-level supervision on those **student-generated** samples. **OPSD** is the special case where the teacher is the *same model* conditioned on privileged information (verified trace / ground-truth answer / region-level visual detail / longer context …).

Each paper is summarized along **four questions**: ① Problem & why it matters · ② Method & key contribution · ③ Task / dataset / model · ④ Limitations & future work.

**Legend** — 🔎 = added via web search (not in the three source lists); the `strictness` badge marks whether a paper is strict OPD (strict / OPD+RL / self-distillation / related-but-not-OPD). ⭐ Star badges update live; citation counts are from Semantic Scholar (snapshot 2026-06; many papers are very recent, so counts keep changing — for reference only).

## 📊 Overview

| Subfield | # | Jump |
| :-- | :--: | :-- |
| 🖼️ VLM Understanding / VQA / Visual Reasoning OPD | 15 | [↳](#-vlm-understanding--vqa--visual-reasoning-opd) |
| 🎬 Video / VideoQA / Temporal Grounding OPD | 7 | [↳](#-video--videoqa--temporal-grounding-opd) |
| 🎨 Image / Video Generation (Diffusion · Flow Matching) OPD | 12 | [↳](#-image--video-generation-diffusion--flow-matching-opd) |
| 🔊 Speech / Audio OPD | 7 | [↳](#-speech--audio-opd) |
| ⚡ Multimodal Speculative-Decoding Distillation | 4 | [↳](#-multimodal-speculative-decoding-distillation) |
| 🤖 Embodied / VLA / GUI / Visual-Agent OPD | 8 | [↳](#-embodied--vla--gui--visual-agent-opd) |
| **Total** | **53** | |

## 🖼️ VLM Understanding / VQA / Visual Reasoning OPD

Core works that transfer reasoning into vision-language models and apply on-policy distillation on VQA / visual-reasoning tasks.

| Paper | Venue / Date | 🌟 | Cites | Strictness |
| :-- | :--: | :--: | :--: | :--: |
| [VOLD — LLM→VLM OPD](https://arxiv.org/abs/2510.23497) | ICLR 2026 | `📄 paper` | 10 | OPD |
| [Uni-OPD — Unified OPD across LLMs & MLLMs](https://arxiv.org/abs/2605.03677) | arXiv 2026 | [![Stars](https://img.shields.io/github/stars/WenjinHou/Uni-OPD?style=flat&label=%E2%AD%90&color=ffd700)](https://github.com/WenjinHou/Uni-OPD) | 5 | OPD |
| [Vision-OPD: Learning to See Fine Details for Multimodal LLMs via On-Policy Self-Distillation](https://arxiv.org/abs/2605.18740) | arXiv 2026 | [![Stars](https://img.shields.io/github/stars/VisionOPD/Vision-OPD?style=flat&label=%E2%AD%90&color=ffd700)](https://github.com/VisionOPD/Vision-OPD) | 2 | OPD |
| [Beyond SFT-to-RL: Pre-alignment via Black-Box On-Policy Distillation for Multimodal RL](https://arxiv.org/abs/2604.28123) | arXiv 2026 | [![Stars](https://img.shields.io/github/stars/XIAO4579/PRISM?style=flat&label=%E2%AD%90&color=ffd700)](https://github.com/XIAO4579/PRISM) | 2 | OPD |
| [ViCuR: Visual Cues as Recoverable Privilege for Multimodal On-Policy Distillation](https://arxiv.org/abs/2606.05718) | arXiv 2026 | [![Stars](https://img.shields.io/github/stars/tiankanghui/ViCuR?style=flat&label=%E2%AD%90&color=ffd700)](https://github.com/tiankanghui/ViCuR) | 1 | OPD |
| [Visual-Advantage On-Policy Distillation for Vision-Language Models](https://arxiv.org/abs/2605.21924) | arXiv 2026 | `📄 paper` | 0 | OPD |
| [Decomposed On-Policy Distillation for Vision-Language Reasoning: Steering Gradients for Visual Grounding](https://arxiv.org/abs/2606.00564) | arXiv 2026 | `📄 paper` | 0 | OPD |
| [KEPO — Knowledge-Enhanced Preference Optimization (Medical VQA)](https://arxiv.org/abs/2602.00400) | arXiv 2026 | [![Stars](https://img.shields.io/github/stars/Corleno/KEPO?style=flat&label=%E2%AD%90&color=ffd700)](https://github.com/Corleno/KEPO) | 0 | OPD+RL (semi-strict) |
| [DeltaPrompts: Escaping the Zero-Delta Trap in Multimodal Distillation](https://arxiv.org/abs/2605.15532) | arXiv 2026 | `📄 paper` | 0 | OPD |
| [Stabilizing On-Policy Distillation for MLLM Reasoning with Global Normalization](https://arxiv.org/abs/2606.09091) | arXiv 2026 | [![Stars](https://img.shields.io/github/stars/OPPO-Mente-Lab/GNDPO?style=flat&label=%E2%AD%90&color=ffd700)](https://github.com/OPPO-Mente-Lab/GNDPO) | 0 | OPD |
| [Self-Distillation Policy Optimization via Visual Feedback: Bridging Code and Visual Artifacts](https://arxiv.org/abs/2606.10334) | arXiv 2026 | `📄 paper` | 0 | OPD |
| [Teaching the Way, Not the Answer: Privileged Tutoring Distillation for Multimodal Policy Optimization](https://arxiv.org/abs/2606.07000) | arXiv 2026 | [![Stars](https://img.shields.io/github/stars/XszNeverSleep/PTD-PO?style=flat&label=%E2%AD%90&color=ffd700)](https://github.com/XszNeverSleep/PTD-PO) | 0 | OPD |
| [Thinking Without Images: Internalizing Visual Manipulation with On-Policy Self-Distillation](https://arxiv.org/abs/2606.08719) | arXiv 2026 | `📄 paper` | 0 | OPD |
| [Learning Visual Spatial Planning from Symbolic State via Modality-Gap-Aware Self-Distillation](https://arxiv.org/abs/2606.06076) | arXiv 2026 | `📄 paper` | 0 | OPD |
| 🔎 [β-KD — Uncertainty-Aware Knowledge Distillation for Multimodal LLMs](https://arxiv.org/abs/2603.21426) | CVPR 2026 | [code](https://github.com/Jingchensun/beta-kd) | 0 | Related · not OPD (offline KD) |

<details>
<summary><b>VOLD — LLM→VLM OPD</b></summary>

`ICLR 2026` · [arXiv](https://arxiv.org/abs/2510.23497) · cited `10`
...
`arXiv 2026` · [arXiv](https://arxiv.org/abs/2605.03677) · [code](https://github.com/WenjinHou/Uni-OPD) · cited `5`
...
`arXiv 2026` · [arXiv](https://arxiv.org/abs/2605.18740) · [code](https://github.com/VisionOPD/Vision-OPD) · cited `2`
...
`arXiv 2026` · [arXiv](https://arxiv.org/abs/2604.28123) · [code](https://github.com/XIAO4579/PRISM) · cited `2`
...
`arXiv 2026` · [arXiv](https://arxiv.org/abs/2606.05718) · [code](https://github.com/tiankanghui/ViCuR) · cited `1`
...
`arXiv 2026` · [arXiv](https://arxiv.org/abs/2605.21924) · cited `0`
...
`arXiv 2026` · [arXiv](https://arxiv.org/abs/2606.00564) · cited `0`
...
`arXiv 2026` · [arXiv](https://arxiv.org/abs/2602.00400) · [code](https://github.com/Corleno/KEPO) · cited `0` · `OPD+RL (semi-strict)`
...
`arXiv 2026` · [arXiv](https://arxiv.org/abs/2605.15532) · cited `0`
...
`arXiv 2026` · [arXiv](https://arxiv.org/abs/2606.09091) · [code](https://github.com/OPPO-Mente-Lab/GNDPO) · cited `0`
...
`arXiv 2026` · [arXiv](https://arxiv.org/abs/2606.10334) · cited `0`
...
`arXiv 2026` · [arXiv](https://arxiv.org/abs/2606.07000) · [code](https://github.com/XszNeverSleep/PTD-PO) · cited `0`
...
`arXiv 2026` · [arXiv](https://arxiv.org/abs/2606.08719) · cited `0`
...
`arXiv 2026` · [arXiv](https://arxiv.org/abs/2606.06076) · cited `0`
...
`CVPR 2026` · [arXiv](https://arxiv.org/abs/2603.21426) · [code](https://github.com/Jingchensun/beta-kd) · cited `0` · `Related · not OPD (offline KD)`
...
## 🎬 Video / VideoQA / Temporal Grounding OPD

OPD / self-distillation for video question answering, video reasoning and temporal grounding, plus the closely related AoTD and VITAL.

| Paper | Venue / Date | 🌟 | Cites | Strictness |
| :-- | :--: | :--: | :--: | :--: |
| 🔎 [VITAL / Thinking With Videos — Multimodal Tool-Augmented RL for Long Video Reasoning](https://arxiv.org/abs/2508.04416) | arXiv 2025.08 | `📄 paper` | 66 | Contains OPD · mainly RL |
| 🔎 [AoTD — Enhancing Video-LLM Reasoning via Agent-of-Thoughts Distillation](https://arxiv.org/abs/2412.01694) | CVPR 2025 | [code](https://github.com/zhengrongz/AoTD) | 34 | Related · not strict OPD |
| [Video-OPD](https://arxiv.org/abs/2602.02994) | arXiv 2026 | `📄 paper` | 8 | OPD |
| [VISD: Enhancing Video Reasoning via Structured Self-Distillation](https://arxiv.org/abs/2605.06094) | arXiv 2026 | `📄 paper` | 3 | OPD |
| [InternVideo3: Agentify Foundation Models with Multimodal Contextual Reasoning](https://arxiv.org/abs/2606.12195) | arXiv 2026 | `📄 paper` | 0 | OPD |
| [World Model Self-Distillation: Training World Models to Solve General Tasks](https://arxiv.org/abs/2606.12072) | arXiv 2026 | `📄 paper` | 0 | OPD |
| [World Models Meet Language Models: On the Complementarity of Concrete and Abstract Reasoning](https://arxiv.org/abs/2606.03603) | arXiv 2026 | `📄 paper` | 0 | OPD |

<details>
<summary><b>🔎 VITAL / Thinking With Videos — Multimodal Tool-Augmented RL for Long Video Reasoning</b></summary>

`arXiv 2025.08` · [arXiv](https://arxiv.org/abs/2508.04416) · cited `66` · `Contains OPD · mainly RL`
...
`CVPR 2025` · [arXiv](https://arxiv.org/abs/2412.01694) · [code](https://github.com/zhengrongz/AoTD) · cited `34` · `Related · not strict OPD`
...
`arXiv 2026` · [arXiv](https://arxiv.org/abs/2602.02994) · cited `8`
...
`arXiv 2026` · [arXiv](https://arxiv.org/abs/2605.06094) · cited `3`
...
`arXiv 2026` · [arXiv](https://arxiv.org/abs/2606.12195) · cited `0`
...
`arXiv 2026` · [arXiv](https://arxiv.org/abs/2606.12072) · cited `0`
...
`arXiv 2026` · [arXiv](https://arxiv.org/abs/2606.03603) · cited `0`
...
## 🎨 Image / Video Generation (Diffusion · Flow Matching) OPD

OPD / self-distillation applied to diffusion and flow-matching generative models (few-step generation, trajectory self-distillation, adversarial distillation).

| Paper | Venue / Date | 🌟 | Cites | Strictness |
| :-- | :--: | :--: | :--: | :--: |
| [π-Flow — Image / Flow OPD](https://arxiv.org/abs/2510.14974) | ICLR 2026 | [![Stars](https://img.shields.io/github/stars/Lakonik/piFlow?style=flat&label=%E2%AD%90&color=ffd700)](https://github.com/Lakonik/piFlow) | 18 | OPD |
| [Di$\mathtt{[M]}$O: Distilling Masked Diffusion Models into One-step Generator](https://arxiv.org/abs/2503.15457) | arXiv 2025 | `📄 paper` | 5 | OPD |
| [LiveTalk: Real-Time Multimodal Interactive Video Diffusion via Improved On-Policy Distillation](https://arxiv.org/abs/2512.23576) | arXiv.org | `📄 paper` | 5 | OPD |
| [Flow-OPD: On-Policy Distillation for Flow Matching Models](https://arxiv.org/abs/2605.08063) | arXiv 2026 | `📄 paper` | 3 | OPD |
| [D-OPSD: On-Policy Self-Distillation for Continuously Tuning Step-Distilled Diffusion Models](https://arxiv.org/abs/2605.05204) | arXiv 2026 | `📄 paper` | 3 | OPD |
| [DiffusionOPD: A Unified Perspective of On-Policy Distillation in Diffusion Models](https://arxiv.org/abs/2605.15055) | arXiv 2026 | `📄 paper` | 1 | OPD |
| [AnyFlow: Any-Step Video Diffusion Model with On-Policy Flow Map Distillation](https://arxiv.org/abs/2605.13724) | arXiv 2026 | `📄 paper` | 1 | OPD |
| [TAD: Temporal-Aware Trajectory Self-Distillation for Fast and Accurate Diffusion LLM](https://arxiv.org/abs/2605.09536) | arXiv 2026 | [![Stars](https://img.shields.io/github/stars/BHmingyang/TAD?style=flat&label=%E2%AD%90&color=ffd700)](https://github.com/BHmingyang/TAD) | 0 | OPD |
| [GDSD: Reinforcement Learning as Guided Denoiser Self-Distillation for Diffusion Language Models](https://arxiv.org/abs/2605.29398) | arXiv 2026 | `📄 paper` | 0 | OPD |
| [CollectionLoRA: Collecting 50 Effects in 1 LoRA via Multi-Teacher On-Policy Distillation](https://arxiv.org/abs/2605.25378) | arXiv 2026 | `📄 paper` | 0 | OPD |
| [Adversarial Dual On-Policy Distillation from Expressive Teacher](https://arxiv.org/abs/2605.27095) | arXiv 2026 | `📄 paper` | 0 | OPD |
| [Knowledge Distillation for Visual Autoregressive Models](https://arxiv.org/abs/2606.06078) | arXiv 2026 | `📄 paper` | 0 | OPD |

<details>
<summary><b>π-Flow — Image / Flow OPD</b></summary>

`ICLR 2026` · [arXiv](https://arxiv.org/abs/2510.14974) · [code](https://github.com/Lakonik/piFlow) · cited `18`
...
`arXiv 2025` · [arXiv](https://arxiv.org/abs/2503.15457) · cited `5`
...
`arXiv.org` · [arXiv](https://arxiv.org/abs/2512.23576) · cited `5`
...
`arXiv 2026` · [arXiv](https://arxiv.org/abs/2605.08063) · cited `3`
...
`arXiv 2026` · [arXiv](https://arxiv.org/abs/2605.05204) · cited `3`
...
`arXiv 2026` · [arXiv](https://arxiv.org/abs/2605.15055) · cited `1`
...
`arXiv 2026` · [arXiv](https://arxiv.org/abs/2605.13724) · cited `1`
...
`arXiv 2026` · [arXiv](https://arxiv.org/abs/2605.09536) · [code](https://github.com/BHmingyang/TAD) · cited `0`
...
`arXiv 2026` · [arXiv](https://arxiv.org/abs/2605.29398) · cited `0`
...
`arXiv 2026` · [arXiv](https://arxiv.org/abs/2605.25378) · cited `0`
...
`arXiv 2026` · [arXiv](https://arxiv.org/abs/2605.27095) · cited `0`
...
`arXiv 2026` · [arXiv](https://arxiv.org/abs/2606.06078) · cited `0`
...
Transferring text reasoning into audio/speech across modalities, or applying OPD to audio understanding and ASR.

| Paper | Venue / Date | 🌟 | Cites | Strictness |
| :-- | :--: | :--: | :--: | :--: |
| [Qwen3-Omni Technical Report](https://arxiv.org/abs/2509.17765) | arXiv.org | `📄 paper` | 316 | OPD |
| [Qwen3.5-Omni](https://arxiv.org/abs/2604.15804) | arXiv 2026 | `📄 paper` | 45 | OPD |
| [Step-Audio-R1](https://arxiv.org/abs/2511.15848) | arXiv 2025 | [![Stars](https://img.shields.io/github/stars/stepfun-ai/Step-Audio-R1?style=flat&label=%E2%AD%90&color=ffd700)](https://github.com/stepfun-ai/Step-Audio-R1) | 28 | OPD |
| [X-OPD — Speech LLM](https://arxiv.org/abs/2603.24596) | arXiv 2026 | `📄 paper` | 5 | OPD |
| [CORD — Reasoning: Text ➡️ Audio](https://arxiv.org/abs/2601.16547) | arXiv 2026 | `📄 paper` | 4 | OPD |
| [Data-Efficient On-Policy Distillation for Automatic Speech Recognition](https://arxiv.org/abs/2605.28139) | arXiv 2026 | `📄 paper` | 0 | OPD |
| [OmniOPSD: Rationale-Privileged On-Policy Self-Distillation for Affective Computing](https://arxiv.org/abs/2606.15920) | arXiv 2026 | `📄 paper` | 0 | OPD |

<details>
<summary><b>Qwen3-Omni Technical Report</b></summary>

`arXiv.org` · [arXiv](https://arxiv.org/abs/2509.17765) · cited `316`
...
`arXiv 2026` · [arXiv](https://arxiv.org/abs/2604.15804) · cited `45`
...
`arXiv 2025` · [arXiv](https://arxiv.org/abs/2511.15848) · [code](https://github.com/stepfun-ai/Step-Audio-R1) · cited `28`
...
`arXiv 2026` · [arXiv](https://arxiv.org/abs/2603.24596) · cited `5`
...
`arXiv 2026` · [arXiv](https://arxiv.org/abs/2601.16547) · cited `4`
...
`arXiv 2026` · [arXiv](https://arxiv.org/abs/2605.28139) · cited `0`
...
`arXiv 2026` · [arXiv](https://arxiv.org/abs/2606.15920) · cited `0`
...
Training on-policy draft models for vision-language models to accelerate inference.

| Paper | Venue / Date | 🌟 | Cites | Strictness |
| :-- | :--: | :--: | :--: | :--: |
| [ViSpec: Accelerating Vision-Language Models with Vision-Aware Speculative Decoding](https://arxiv.org/abs/2509.15235) | arXiv.org | `📄 paper` | 14 | OPD |
| [Speculative Decoding Reimagined for Multimodal Large Language Models](https://arxiv.org/abs/2505.14260) | arXiv.org | `📄 paper` | 6 | OPD |
| [SpecVLM: Fast Speculative Decoding in Vision-Language Models](https://arxiv.org/abs/2509.11815) | arXiv.org | `📄 paper` | 4 | OPD |
| [MASSV — Multimodal SD Draft](https://arxiv.org/abs/2505.10526) | arXiv 2025 | `📄 paper` | 0 | OPD |

<details>
<summary><b>ViSpec: Accelerating Vision-Language Models with Vision-Aware Speculative Decoding</b></summary>

`arXiv.org` · [arXiv](https://arxiv.org/abs/2509.15235) · cited `14`
...
`arXiv.org` · [arXiv](https://arxiv.org/abs/2505.14260) · cited `6`
...
`arXiv.org` · [arXiv](https://arxiv.org/abs/2509.11815) · cited `4`
...
`arXiv 2025` · [arXiv](https://arxiv.org/abs/2505.10526) · cited `0`
...
## 🤖 Embodied / VLA / GUI / Visual-Agent OPD

The student is a visual agent or VLA policy, supervised by a teacher (or itself) on its own visual trajectories.

| Paper | Venue / Date | 🌟 | Cites | Strictness |
| :-- | :--: | :--: | :--: | :--: |
| [Refined Policy Distillation (RPD)](https://arxiv.org/abs/2503.05833) | IROS 2026 | [![Stars](https://img.shields.io/github/stars/Refined-Policy-Distillation/RPD?style=flat&label=%E2%AD%90&color=ffd700)](https://github.com/Refined-Policy-Distillation/RPD) | 16 | OPD |
| [HY-Embodied-0.5](https://arxiv.org/abs/2604.07430) | arXiv 2026 | [![Stars](https://img.shields.io/github/stars/Tencent-Hunyuan/HY-Embodied?style=flat&label=%E2%AD%90&color=ffd700)](https://github.com/Tencent-Hunyuan/HY-Embodied) | 4 | OPD |
| [VLA-OPD](https://arxiv.org/abs/2603.26666) | arXiv 2026 | `📄 paper` | 3 | OPD |
| [HyperEyes — Parallel Multimodal Search Agent](https://arxiv.org/abs/2605.07177) | arXiv 2026 | [![Stars](https://img.shields.io/github/stars/DeepExperience/HyperEyes?style=flat&label=%E2%AD%90&color=ffd700)](https://github.com/DeepExperience/HyperEyes) | 1 | OPD |
| [CoPD — Co-Evolving Policy Distillation](https://arxiv.org/abs/2604.27083) | arXiv 2026 | `📄 paper` | 1 | OPD |
| [Learn where to Click from Yourself: On-Policy Self-Distillation for GUI Grounding](https://arxiv.org/abs/2605.00642) | arXiv 2026 | `📄 paper` | 1 | OPD |
| [GeoDrive-Bench: Benchmarking Region-Specific Multimodal Reasoning in Autonomous Driving](https://arxiv.org/abs/2606.02774) | arXiv 2026 | `📄 paper` | 0 | OPD |
| [LiteGUI: Distilling Compact GUI Agents with Reinforcement Learning](https://arxiv.org/abs/2605.07505) | arXiv 2026 | `📄 paper` | 0 | OPD |

<details>
<summary><b>Refined Policy Distillation (RPD)</b></summary>

`IROS 2026` · [arXiv](https://arxiv.org/abs/2503.05833) · [code](https://github.com/Refined-Policy-Distillation/RPD) · cited `16`
...
`arXiv 2026` · [arXiv](https://arxiv.org/abs/2604.07430) · [code](https://github.com/Tencent-Hunyuan/HY-Embodied) · cited `4`
...
`arXiv 2026` · [arXiv](https://arxiv.org/abs/2603.26666) · cited `3`
...
`arXiv 2026` · [arXiv](https://arxiv.org/abs/2605.07177) · [code](https://github.com/DeepExperience/HyperEyes) · cited `1`
...
`arXiv 2026` · [arXiv](https://arxiv.org/abs/2604.27083) · cited `1`
...
`arXiv 2026` · [arXiv](https://arxiv.org/abs/2605.00642) · cited `1`
...
`arXiv 2026` · [arXiv](https://arxiv.org/abs/2606.02774) · cited `0`
...
`arXiv 2026` · [arXiv](https://arxiv.org/abs/2605.07505) · cited `0`
...
- Paper sources and four-point summaries are compiled from the technical tables of the three source awesome lists, the papers' arXiv abstracts, and public materials; errors are possible — **please refer to the original papers**.
...
- Snapshot: 2026-06. ⭐ Star badges refresh live via shields.io; citation counts come from Semantic Scholar and change over time.
- PRs welcome for new papers and corrections.

## 📄 License

[![CC0](https://licensebuttons.net/p/zero/1.0/88x31.png)](https://creativecommons.org/publicdomain/zero/1.0/) Released under CC0 (public domain dedication) — free to use.
